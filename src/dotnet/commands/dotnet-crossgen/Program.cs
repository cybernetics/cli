...
namespace Microsoft.DotNet.Tools.CrossGen
{
    public static class CrossGenCommand
    {
        public static int Run(string[] args)
        {
            ...
            var outputStructureParam = app.Option("--output-structure", "(Optional) Structure of the output. FLAT to preserve input directory structure, CACHE for folding up to optimization cache format. Default is FLAT.", CommandOptionType.SingleValue);
            ...
            app.OnExecute( () => {
                ...
                {
                    outputStructure = CrossGenOutputStructure.FLAT;
                }
